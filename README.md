...
3. How do the volume of products and median revenue vary between clothing and footwear-type items?
...
1. There is an astronomical gap in both average revenue and number of distinct products sold across all price categories between Adidas and Nike, as shown below:
